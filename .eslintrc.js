module.exports = {
  extends: ["prettier", "airbnb", "plugin:flowtype/recommended", "prettier/react", "prettier/flowtype", "plugin:jest/recommended", "plugin:prettier/recommended"],
  parser: "babel-eslint",
  plugins: ["prettier", "flowtype", "emotion", "react", "react-hooks", "import", "jest", "es5"],
  env: {
    es6: true,
    browser: true,
    node: true,
  ...
  rules: {
    ...
    "no-restricted-syntax": [
      ...
      // (also covered by `no-new-wrappers` but i am having fun)
      {
        ...
        message: "Avoid using constructor: `new Boolean(value)` as it creates a Boolean object. Did you mean `Boolean(value)`?",
      },
      ...
      // to ensure we still get the benefits of `eslint-plugin-react-hooks`
      {
        ...
        message: "Must use `useLayoutEffect` as the name of the import from `*use-isomorphic-layout-effect` to leverage `eslint-plugin-react-hooks`",
      },
      ...
      // No Array.from as it pulls in a large amount of babel helpers
      {
        ...
        message: "Not allowing using of Array.from to save kbs. Please use native-with-fallback/from",
      },
